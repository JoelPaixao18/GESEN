                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-6">
                                    <ul class="chart-list-out">
                                        ...
                                        <li><span class="circle-green"></span>Estudante</li>
                ...
                <div class="col-md-12 col-lg-6">
                    ...
                    <div class="card card-chart">
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col-6">
                                    <h5 class="card-title">Números de Estudantes</h5>
                                </div>
                                <div class="col-6">
                                    <ul class="chart-list-out">
            ...
            <div class="row">
                <div class="col-xl-6 d-flex">
                    ...
                    <div class="card flex-fill student-space comman-shadow">
                        <div class="card-header d-flex align-items-center">
                            <h5 class="card-title">Estudantes Destacados</h5>
                                ...
                                <table class="table star-student table-hover table-center table-borderless table-striped">
                                    <thead class="thead-light">
                                        <tr>
                                            ...
                                            <th class="text-center">Percentagens</th>
                ...
                <div class="col-xl-6 d-flex">
                    ...
                    <div class="card flex-fill comman-shadow">
                        <div class="card-header d-flex align-items-center">
                            <h5 class="card-title ">Atividades dos Alunos </h5>
                            <ul class="chart-list-out student-ellips">
                                <li class="star-menus"><a href="javascript:;"><i class="fas fa-ellipsis-v"></i></a>
                                </li>
                            </ul>
