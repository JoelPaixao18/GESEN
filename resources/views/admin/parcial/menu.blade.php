        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li class="submenu active">
                    <a href="#"><i class="feather-grid"></i> <span> Painel</span> <span
                            class="menu-arrow"></span></a>
                    <ul>
                        <li><a href="index.html" class="active">Painel Administrativo</a></li>
                ...
                <li class="submenu">
                    <a href="#"><i class="fas fa-solid fa-school"></i> <span> Escola</span> <span
                            class="menu-arrow"></span></a>
                    <ul>
                        <li><a href="students.html">Listar Escola</a></li>
                        <li><a href="student-details.html">Visualizar Escola</a></li>
                        <li><a href="add-student.html">Adicionar Escola</a></li>
                        <li><a href="edit-student.html">Editar Escola</a></li>
                    </ul>
                </li>
                <li class="submenu">
