...
<head>
    ...
    <link rel="shortcut icon" href="{{ url('assets/img/favicon1.png') }}" type="image/x-icon">
...
<body>
    @include('admin.students.adicionar.parcial.header')
    @include('admin.students.adicionar.parcial.menu')
